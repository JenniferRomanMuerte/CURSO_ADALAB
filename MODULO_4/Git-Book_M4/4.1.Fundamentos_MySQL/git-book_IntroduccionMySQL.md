...
En este módulo vamos a aprender a desarrollar aplicaciones de servidor con [**Node JS**](https://nodejs.org/es/). Pero no solo eso, tambien vamos a integrar todo lo aprendido anteriormente para desarrollar aplicaciones web donde programemos tanto backend como frontend.

Para ello vamos a aprender a usar el [**framework Express JS**](https://expressjs.com/es/), que nos ayuda a montar un servidor; es decir, **nos ayuda a escuchar, procesar y responder las peticiones que se hacen desde una web**, ya sean peticiones a una API a través de un `fetch` o peticiones a ficheros (HTML, CSS, imágenes...) que realiza directamente el navegador.

Por último vamos a aprender a trabajar con la [**base de datos SQL**](https://www.mysql.com/) y con **bases de datos NO SQL**, para poder almacenar en el servidor los datos de las usuarias de nuestras aplicaciones.

Si unimos estos nuevos conceptos con los que hemos aprendido durante todo el curso, estaremos hablando de uno de los stack o conjunto de herramientas más utilizadas en el mundillo en la actualidad: **MERN**.

**MERN** es el conjunto de marcos/tecnologías utilizados para el desarrollo web de aplicaciones que consta de MongoDB, React JS, Express JS y Node JS como sus componentes.
...
* Cómo estructurar esta información en una bases de datos MYSQL.
...
* Cómo estructurar esta información en una bases de datos NO SQL como MongoDB
...
* Leas, además de estos materiales, la [documentación oficial de Node](https://nodejs.org/dist/latest-v14.x/docs/api/), ya que está muy bien escrita. **Queremos que te acostumbres a leer documentación técnica por Internet.**
...
* Disfrutes aprendiendo y programando servidores y lo integres con aplicacioes de front.

Cuando finalicemos este módulo sabrás **hacer aplicaciones de servidor pequeñas** e intregrarlas con apliccions de frontend y serás capaz de **seguir aprendiendo por tu cuenta**.

**Sin duda podrás optar a posiciones de desarrolladora junior de back end con Node JS o de full stack con MERN.**

# 4.1.1 Comunicación entre front y back

{% hint style="info" %}
**Nota:** Esta lección es importante, te servirá para entender las bases de como se comunica el back y el front.
{% endhint %}
...
![](https://2908775143-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FFeL5m4e6ES4PMjY0BYJw%2Fuploads%2Fgit-blob-cd3e400ddbc201eb8fd90a3e6bae02077b552154%2Fcomunicacion-entre-front-y-back.png?alt=media)

### Cómo se comunican el front y el back

{% embed url="<https://www.youtube.com/watch?v=vGdrM07TZ3I>" %}
